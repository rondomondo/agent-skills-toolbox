...
## See some real game examples

Here would be a set of existing cards (the html rendered in a 'card' - as in the web user interface (UI) design component ) to play immediately inline
