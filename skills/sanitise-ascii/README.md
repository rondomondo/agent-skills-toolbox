...
**Try it:** [find4.org/sanitise](https://find4.org/sanitise/#)

[![sanitise screenshot](images/sanitise-screenshot.png)](https://find4.org/sanitise/#)

Paste or upload text, toggle options, and download the sanitised result -- all in the browser.
